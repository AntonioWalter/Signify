...
Gli algoritmi di classificazione tradizionali --- Decision Tree, Random Forest, k-Nearest Neighbors --- condividono un requisito fondamentale: operano su \textbf{vettori di feature a dimensione fissa}. Non sono progettati per ricevere in input sequenze di lunghezza variabile in cui l'ordine dei dati è importante.
