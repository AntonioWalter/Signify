...
Dopo aver descritto la scelta teorica nel capitolo precedente, questa sezione analizza l'implementazione pratica dell'architettura \textbf{LSTM + Attention} e del ciclo di addestramento. Tutto il codice sorgente è stato scritto in linguaggio \textit{Python} avvalendosi del framework \textit{PyTorch}, uno degli strumenti accademici e industriali più diffusi in ambito Machine Learning.
